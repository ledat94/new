...
void haikei(){
 ...
 fill(219,220,225); /*clouds*/
  ...
  String s = "HANNO STATION"; /*text*/
  fill(50);
  text(s, 760, 175, 800, 180);
  textSize(15);
  fill(236,251,254);
  ...
  rect(820,260,35,23);
   ...
   String e = "Copyright@ Le Duc Dat"; /*text*/
  fill(50);
...
int trains3015803 (int x0, int y0, int n){
  int i;
  for (i=0;i<n;i++){
    if(i>0){
      stroke(127);
...
int train3015803( int x0, int y0 ) {
  stroke(0);
